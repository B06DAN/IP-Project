    ...
    <head>
        ...
        <style>
            *{margin:0px; padding:0px;font-family: Helvetica, Arial, sans-serif;}
            ...
            #container{width:75%; height:auto; position:relative; top:8px; margin:auto;border: 1px solid #333;padding: 15px;}

            #session-name{width:100%; height:36px; margin-bottom:30px; font-size:20px}
            .session-text{width:300px; color: #333; height:30px;padding:6px 10px;margin: 8px 0;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box; font-size:24px}
